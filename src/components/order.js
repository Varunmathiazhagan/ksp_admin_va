          ...
          <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-3 sm:p-4 rounded-lg shadow-sm h-52 sm:h-64 overflow-auto">
            <div className="space-y-2">
              {orders.slice(0, 5).map((order, index) => (
                <div key={index} className="flex items-center p-2 sm:p-3 rounded-lg hover:bg-white transition-colors duration-200 border border-transparent hover:border-gray-200 shadow-sm">
                  <div className={`w-3 h-3 sm:w-2 sm:h-2 rounded-full mr-2 ${
                    order.orderStatus === 'delivered' ? 'bg-gradient-to-r from-green-400 to-green-500' : 
                    order.orderStatus === 'processing' ? 'bg-gradient-to-r from-amber-400 to-amber-500' : 
                    order.orderStatus === 'shipped' ? 'bg-gradient-to-r from-blue-400 to-blue-500' : 'bg-gradient-to-r from-red-400 to-red-500'
                  }`}></div>
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-xs capitalize">{order.orderStatus}</p>
                  </div>
                </div>
              ))}
            </div>
